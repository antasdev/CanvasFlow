...
import { calculateCircleGeometry } from "../utils/shape-geometry.utils";
...
export default function CircleNode({
  ...
  boardId,
  canEditCanvas = true,
}: CircleNodeProps): React.JSX.Element {
  ...
  const circleGeom = calculateCircleGeometry(
  ...
  return (
    <>
      ...
      >
        <Circle
          x={circleGeom.centerX}
          y={circleGeom.centerY}
